...
namespace Drupal\rcb_statistics;
...
class StatisticsSettingsForm extends ConfigFormBase {
  ...
  /**
   * Constructs a \Drupal\rcb_statistics\StatisticsSettingsForm object.
   *
  ...
  protected function getEditableConfigNames() {
    return ['rcb_statistics.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('rcb_statistics.settings');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->config('rcb_statistics.settings')
