/**
 * @file
 * Overrides Drupal core's responsive table functionality.
 */
...
(function ($, Drupal, window) {
  ...
  function TableResponsive(table) {
    ...
    this.$table.before($('<div class="table-behaviours"><div class="tableresponsive-toggle-columns"></div></div>').append(this.$link));
