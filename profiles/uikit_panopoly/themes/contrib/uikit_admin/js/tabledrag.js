...
(function ($, Drupal, drupalSettings) {
  ...
  Drupal.tableDrag = function (table, tableSettings) {
    ...
    $('.table-behaviours').append($('<a class="link tabledrag-toggle-weight"></a>')
  ...
  Drupal.tableDrag.prototype.makeDraggable = function (item) {
    ...
    // Create the handle.
    var handle = $('<a href="#" class="tabledrag-handle"><div class="handle"><i class="uk-icon-arrows uk-text-muted"></i></div></a>').attr('title', Drupal.t('Drag to re-order'));
    ...
    if (self.rowObject !== null) {
      ...
      if (self.rowObject.changed === true) {
        ...
        if (self.changed === false) {
          $('.table-behaviours').prepend($(Drupal.theme('tableDragChangedWarning'))).hide().fadeIn('slow');
          self.changed = true;
        }
      }
  ...
  $.extend(Drupal.theme, /** @lends Drupal.theme */{
    ...
    tableDragChangedMarker: function () {
      return '<i class="uk-icon-asterisk uk-text-warningfhan tabledrag-changed" title="' + Drupal.t('Changed') + '"></i>';
    },

    /**
     * @return {string}
     *  Markup for the message marker.
     */
    tableDragChangedMessageMarker: function () {
      return '<i class="uk-icon-asterisk uk-text-warning tabledrag-changed" title="' + Drupal.t('Changed') + '"></i>';
    },
    ...
    tableDragChangedWarning: function () {
      return '<div class="tabledrag-changed-warning uk-alert uk-alert-warning" role="alert">' + Drupal.theme('tableDragChangedMessageMarker') + Drupal.t('You have unsaved changes.') + '</div>';
    }
  });
